...
'''
    ...
    def __init__(self, seq_name=None, dets='',vis_threshold=0.0,
        ...
        self._dets = dets
        #self._seq_name = ''.join(seq_name) #I have added join to convert seq_name from list to string
        #self._dets = ''
        ...
        #self._train_folders = "/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/data/MOT17Det/train"
        self._test_folders = os.listdir(os.path.join(self._mot_dir, 'test'))
        #self._test_folders = "/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/data/MOT17Det/test"

        self.transforms = ToTensor()

        #seq_name = ''.join(seq_name) #I have added join to convert seq_name from list to string
    ...
    def _sequence(self):
        ...
        config_file = "/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/data/MOT17Det/train/MOT17-02/seqinfo.ini"
        ...
        gt_file = "/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/data/MOT17Det/train/MOT17-02/gt/gt.txt"
        ...
        det_file = self.get_det_file(mot17_label_path)
    ...
    def get_det_file(self, mot17_label_path):

      det_file = "/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/output/faster_rcnn_fpn_training_mot_17/MOT17-02.txt"
      '''det_file = osp.join(
            mot17_label_path,
