...
class Solver(object):
	...
	def train(self, model, train_loader, val_loader=None, num_epochs=10, log_nth=0, model_args={}):
		...
		for epoch in range(num_epochs):
			...
			for i, batch in enumerate(train_loader, 1): #el uno es el index por el que empieza el bucle. El i recoge el numero de iteración.
				#inputs, labels = Variable(batch[0]), Variable(batch[1])
				#MIRAR EN EL ORIGINAL EL FORMATO QUE COGE TRAIN LOADER PORUQE IGUAL ME PUEDO CARGAR EL FOR QUE ME DA ERROR.
