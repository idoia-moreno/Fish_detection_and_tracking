...
from tracktor.utils_CPU import interpolate, plot_sequence, get_mot_accum, evaluate_mot_accums

ex = Experiment()

ex.add_config('/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/experiments/cfgs/tracktor.yaml')
...
ex.add_named_config('oracle', '/home/idoia/Documentos/TFM/GITHUB/tracking_wo_bnw/experiments/cfgs/oracle_tracktor.yaml')
